...
export const Products = () => {
    ...
    // Handle add product
    const handleAddProduct = async (productData: CreateProductFormData) => {
        try {
            const newProduct = await productService.createProduct(productData);
            if (newProduct) {
                // Refresh current page to show new product
                refresh();
                success('Product Created', `"${newProduct.name}" has been successfully created.`);
            }
        } catch (error: any) {
    ...
    const handleDeleteProduct = async (product: Product) => {
        if (window.confirm(`Are you sure you want to delete "${product.name}"?`)) {
            try {
                ...
                refresh();
                success('Product Deleted', `"${product.name}" has been successfully deleted.`);
            } catch (error: any) {
